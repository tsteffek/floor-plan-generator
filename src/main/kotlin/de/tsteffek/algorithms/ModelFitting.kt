...
private tailrec fun <T : Point> fitLines(
    ...
    val initialNeighbors = LinkedList(
        getNotTakenNeighbors(
            startPoint,
            takenPoints,
            graph
        )
...
private tailrec fun <T : Point> findNeighborsOnLine(
    ...
    return if (maxDistance > THRESHOLD) {
        ...
        val notTakenNeighbors =
            getNotTakenNeighbors(nearestPoint, takenPoints, graph)
